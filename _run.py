...
# Важно - вызывается один раз по завершению выполнения всех процессов
...
def main():
    ...
    # Готовим объект для общего использования (к сожалению, там могут быть только int-ы или массивы)
